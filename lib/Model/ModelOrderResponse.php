 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelOrderResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_OrderResponse';
...
'update' => '\DateTime',
'order_number' => 'string',
'contact' => '\Swagger\Client\Model\ModelOrderResponseContact',
'order_date' => '\DateTime',
'status' => 'string',
'header' => 'string',
'head_text' => 'string',
'foot_text' => 'string',
'address_country' => '\Swagger\Client\Model\ModelOrderResponseAddressCountry',
'create_user' => '\Swagger\Client\Model\ModelInvoiceResponseCreateUser',
'sev_client' => '\Swagger\Client\Model\ModelOrderResponseSevClient',
'delivery_terms' => 'string',
'payment_terms' => 'string',
'origin' => '\Swagger\Client\Model\ModelOrderResponseOrigin',
'version' => 'string',
'small_settlement' => 'bool',
'contact_person' => '\Swagger\Client\Model\ModelOrderResponseContactPerson',
'tax_rate' => 'string',
'tax_set' => '\Swagger\Client\Model\ModelOrderResponseTaxSet',
'tax_text' => 'string',
'tax_type' => 'string',
'order_type' => 'string',
'send_date' => '\DateTime',
...
self::SEND_TYPE_VP,        ];
     ...
     * Gets contact
     *
     * @return \Swagger\Client\Model\ModelOrderResponseContact
     */
     ...
     * Sets contact
     *
     * @param \Swagger\Client\Model\ModelOrderResponseContact $contact contact
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Please have a look in       <a href='https://api.sevdesk.de/#section/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ModelOrderResponseAddressCountry
     */
     ...
     *
     * @param \Swagger\Client\Model\ModelOrderResponseAddressCountry $address_country address_country
     *
     * @return $this
     */
     ...
     * Gets sev_client
     *
     * @return \Swagger\Client\Model\ModelOrderResponseSevClient
     */
     ...
     * Sets sev_client
     *
     * @param \Swagger\Client\Model\ModelOrderResponseSevClient $sev_client sev_client
     *
     * @return $this
     */
     ...
     * Gets origin
     *
     * @return \Swagger\Client\Model\ModelOrderResponseOrigin
     */
     ...
     * Sets origin
     *
     * @param \Swagger\Client\Model\ModelOrderResponseOrigin $origin origin
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param string $version Version of the order.<br>      Can be used if you have multiple drafts for the same order.<br>      Should start with 0
     *
     * @return $this
     */
     ...
     * Gets contact_person
     *
     * @return \Swagger\Client\Model\ModelOrderResponseContactPerson
     */
     ...
     * Sets contact_person
     *
     * @param \Swagger\Client\Model\ModelOrderResponseContactPerson $contact_person contact_person
     *
     * @return $this
     */
     ...
     * Sets tax_rate
     *
     * @param string $tax_rate Is overwritten by order position tax rates
     *
     * @return $this
     */
     ...
     * Gets tax_set
     *
     * @return \Swagger\Client\Model\ModelOrderResponseTaxSet
     */
     ...
     * Sets tax_set
     *
     * @param \Swagger\Client\Model\ModelOrderResponseTaxSet $tax_set tax_set
     *
     * @return $this
     */
     ...
     * Sets sum_net
     *
     * @param string $sum_net Net sum of the order
     *
     * @return $this
     */
     ...
     * Sets sum_tax
     *
     * @param string $sum_tax Tax sum of the order
     *
     * @return $this
     */
     ...
     * Sets sum_gross
     *
     * @param string $sum_gross Gross sum of the order
     *
     * @return $this
     */
     ...
     * Sets sum_discounts
     *
     * @param string $sum_discounts Sum of all discounts in the order
     *
     * @return $this
     */
     ...
     *
     * @param string $sum_net_foreign_currency Net sum of the order in the foreign currency
     *
     * @return $this
     */
     ...
     *
     * @param string $sum_tax_foreign_currency Tax sum of the order in the foreign currency
     *
     * @return $this
     */
     ...
     *
     * @param string $sum_gross_foreign_currency Gross sum of the order in the foreign currency
     *
     * @return $this
     */
     ...
     *
     * @param string $sum_discounts_foreign_currency Discounts sum of the order in the foreign currency
     *
     * @return $this
     */
