 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelChangeLayoutResponseMetadaten implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_ChangeLayoutResponse_metadaten';
...
'doc_id' => 'getDocId'    ];
     ...
     * Sets thumbs
     *
     * @param object $thumbs the pdf file
     *
     * @return $this
     */
     ...
     * Sets pages
     *
     * @param int $pages the number of pages in the document
     *
     * @return $this
     */
