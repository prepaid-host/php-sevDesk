 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelCheckAccount implements ModelInterface, ArrayAccess
{
...
'create' => '\DateTime',
'update' => '\DateTime',
'sev_client' => '\Swagger\Client\Model\ModelCheckAccountSevClient',
'name' => 'string',
'type' => 'string',
'import_type' => 'string',
'currency' => 'string',
...
const DEFAULT_ACCOUNT_0 = 0;
const DEFAULT_ACCOUNT_1 = 1;
const STATUS_0 = 0;
...
self::STATUS_100,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['default_account'] = isset($data['default_account']) ? $data['default_account'] : DEFAULT_ACCOUNT.0;
        $this->container['status'] = isset($data['status']) ? $data['status'] : STATUS.100;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['default_account']) && !in_array($this->container['default_account'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'default_account', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets id
     *
     * @param int $id The check account id
     *
     * @return $this
     */
     ...
     * Gets sev_client
     *
     * @return \Swagger\Client\Model\ModelCheckAccountSevClient
     */
     ...
     * Sets sev_client
     *
     * @param \Swagger\Client\Model\ModelCheckAccountSevClient $sev_client sev_client
     *
     * @return $this
     */
     ...
     *
     * @param int $default_account Defines if this check account is the default account.
     *
     * @return $this
     */
     ...
     *
     * @param int $auto_map_transactions Defines if transactions on this account are automatically mapped to invoice and vouchers when imported if possible.
     *
     * @return $this
     */
