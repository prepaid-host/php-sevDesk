 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelCheckAccountResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_CheckAccountResponse';
...
'create' => '\DateTime',
'update' => '\DateTime',
'sev_client' => '\Swagger\Client\Model\ModelCheckAccountResponseSevClient',
'name' => 'string',
'type' => 'string',
'import_type' => 'string',
'currency' => 'string',
...
const IMPORT_TYPE_MT940 = 'MT940';
const IMPORT_TYPE_NULL = 'null';
const STATUS__0 = '0';
...
self::STATUS__100,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['default_account'] = isset($data['default_account']) ? $data['default_account'] : '0';
        $this->container['status'] = isset($data['status']) ? $data['status'] : '100';
        $this->container['bank_server'] = isset($data['bank_server']) ? $data['bank_server'] : null;
        $this->container['auto_map_transactions'] = isset($data['auto_map_transactions']) ? $data['auto_map_transactions'] : '1';
    }
     ...
     * Sets id
     *
     * @param string $id The check account id
     *
     * @return $this
     */
     ...
     * Sets object_name
     *
     * @param string $object_name The check account object name
     *
     * @return $this
     */
     ...
     * Sets create
     *
     * @param \DateTime $create Date of check account creation
     *
     * @return $this
     */
     ...
     * Sets update
     *
     * @param \DateTime $update Date of last check account update
     *
     * @return $this
     */
     ...
     * Gets sev_client
     *
     * @return \Swagger\Client\Model\ModelCheckAccountResponseSevClient
     */
     ...
     * Sets sev_client
     *
     * @param \Swagger\Client\Model\ModelCheckAccountResponseSevClient $sev_client sev_client
     *
     * @return $this
     */
     ...
     * Sets import_type
     *
     * @param string $import_type Import type. Transactions can be imported by this method on the check account.
     *
     * @return $this
     */
     ...
     *
     * @param string $default_account Defines if this check account is the default account.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Status of the check account. 0 <-> Archived - 100 <-> Active
     *
     * @return $this
     */
     ...
     * Sets bank_server
     *
     * @param string $bank_server Bank server of check account
     *
     * @return $this
     */
     ...
     *
     * @param string $auto_map_transactions Defines if transactions on this account are automatically mapped to invoice and vouchers when imported if possible.
     *
     * @return $this
     */
