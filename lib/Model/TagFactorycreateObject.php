...
/**
 * TagFactorycreateObject Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TagFactorycreateObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TagFactorycreate_object';
...
'object_name' => 'getObjectName'    ];
    ...
    const OBJECT_NAME_INVOICE = 'Invoice';
const OBJECT_NAME_VOUCHER = 'Voucher';
const OBJECT_NAME_ORDER = 'Order';
const OBJECT_NAME_CREDIT_NOTE = 'CreditNote';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['object_name']) && !in_array($this->container['object_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'object_name', must be one of '%s'",
