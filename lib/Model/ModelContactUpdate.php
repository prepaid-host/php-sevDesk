 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelContactUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_ContactUpdate';
...
'parent' => '\Swagger\Client\Model\ModelContactUpdateParent',
'surename' => 'string',
'familyname' => 'string',
'titel' => 'string',
'category' => '\Swagger\Client\Model\ModelContactUpdateCategory',
'description' => 'string',
...
'exempt_vat' => 'bool',
'tax_type' => 'string',
'tax_set' => '\Swagger\Client\Model\ModelContactTaxSet',
...
self::TAX_TYPE_SS,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = isset($data['status']) ? $data['status'] : 100;
     ...
     * Sets status
     *
     * @param int $status Defines the status of the contact. 100 <-> Lead - 500 <-> Pending - 1000 <-> Active.
     *
     * @return $this
     */
     ...
     * Gets parent
     *
     * @return \Swagger\Client\Model\ModelContactUpdateParent
     */
     ...
     * Sets parent
     *
     * @param \Swagger\Client\Model\ModelContactUpdateParent $parent parent
     *
     * @return $this
     */
     ...
     * Gets category
     *
     * @return \Swagger\Client\Model\ModelContactUpdateCategory
     */
     ...
     * Sets category
     *
     * @param \Swagger\Client\Model\ModelContactUpdateCategory $category category
     *
     * @return $this
     */
     ...
     *
     * @param int $default_cashback_time Absolute time in days which the contact has to pay his invoices and subsequently get a cashback.
     *
     * @return $this
     */
     ...
     *
     * @param float $default_cashback_percent Percentage of the invoice sum the contact gets back if he payed invoices in time.
     *
     * @return $this
     */
     ...
     *
     * @param int $default_time_to_pay The payment goal in days which is set for every invoice of the contact.
     *
     * @return $this
     */
     ...
     * Sets exempt_vat
     *
     * @param bool $exempt_vat Defines if the contact is freed from paying vat.
     *
     * @return $this
     */
     ...
     * Gets tax_set
     *
     * @return \Swagger\Client\Model\ModelContactTaxSet
     */
     ...
     * Sets tax_set
     *
     * @param \Swagger\Client\Model\ModelContactTaxSet $tax_set tax_set
     *
     * @return $this
     */
     ...
     *
     * @param float $default_discount_amount The default discount the contact gets for every invoice.<br> Depending on defaultDiscountPercentage attribute, in percent or absolute value.
     *
     * @return $this
     */
     ...
     *
     * @param bool $default_discount_percentage Defines if the discount is a percentage (true) or an absolute value (false).
     *
     * @return $this
     */
     ...
     *
     * @param bool $government_agency Defines whether the contact is a government agency (true) or not (false).
     *
     * @return $this
     */
