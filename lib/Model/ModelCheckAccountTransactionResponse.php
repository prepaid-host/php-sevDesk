 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelCheckAccountTransactionResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_CheckAccountTransactionResponse';
...
'create' => '\DateTime',
'update' => '\DateTime',
'sev_client' => '\Swagger\Client\Model\ModelCheckAccountTransactionResponseSevClient',
'value_date' => '\DateTime',
'entry_date' => '\DateTime',
'paymt_purpose' => 'string',
'amount' => 'string',
'payee_payer_name' => 'string',
'check_account' => '\Swagger\Client\Model\ModelCheckAccountTransactionResponseCheckAccount',
'status' => 'string',
'enshrined' => '\DateTime',
'source_transaction' => '\Swagger\Client\Model\ModelCheckAccountTransactionResponseSourceTransaction',
'target_transaction' => '\Swagger\Client\Model\ModelCheckAccountTransactionResponseTargetTransaction'    ];
...
self::STATUS__400,        ];
     ...
     * Sets id
     *
     * @param string $id The check account transaction id
     *
     * @return $this
     */
     ...
     * Sets object_name
     *
     * @param string $object_name The check account transaction object name
     *
     * @return $this
     */
     ...
     * Sets create
     *
     * @param \DateTime $create Date of check account transaction creation
     *
     * @return $this
     */
     ...
     * Sets update
     *
     * @param \DateTime $update Date of last check account transaction update
     *
     * @return $this
     */
     ...
     * Gets sev_client
     *
     * @return \Swagger\Client\Model\ModelCheckAccountTransactionResponseSevClient
     */
     ...
     * Sets sev_client
     *
     * @param \Swagger\Client\Model\ModelCheckAccountTransactionResponseSevClient $sev_client sev_client
     *
     * @return $this
     */
     ...
     * Sets value_date
     *
     * @param \DateTime $value_date Date the check account transaction was imported
     *
     * @return $this
     */
     ...
     * Sets entry_date
     *
     * @param \DateTime $entry_date Date the check account transaction was booked
     *
     * @return $this
     */
     ...
     * Sets paymt_purpose
     *
     * @param string $paymt_purpose the purpose of the transaction
     *
     * @return $this
     */
     ...
     * Gets check_account
     *
     * @return \Swagger\Client\Model\ModelCheckAccountTransactionResponseCheckAccount
     */
     ...
     * Sets check_account
     *
     * @param \Swagger\Client\Model\ModelCheckAccountTransactionResponseCheckAccount $check_account check_account
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Status of the check account transaction.<br>       100 <-> Created<br>       200 <-> Linked<br>       300 <-> Private<br>       400 <-> Booked
     *
     * @return $this
     */
     ...
     * Sets enshrined
     *
     * @param \DateTime $enshrined Defines if the transaction has been enshrined and can not be changed any more.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ModelCheckAccountTransactionResponseSourceTransaction
     */
     ...
     *
     * @param \Swagger\Client\Model\ModelCheckAccountTransactionResponseSourceTransaction $source_transaction source_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ModelCheckAccountTransactionResponseTargetTransaction
     */
     ...
     *
     * @param \Swagger\Client\Model\ModelCheckAccountTransactionResponseTargetTransaction $target_transaction target_transaction
     *
     * @return $this
     */
