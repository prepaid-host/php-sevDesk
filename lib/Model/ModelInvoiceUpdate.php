 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelInvoiceUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Model_InvoiceUpdate';
...
'contact' => '\Swagger\Client\Model\ModelInvoiceUpdateContact',
'create' => '\DateTime',
'update' => '\DateTime',
...
'dunning_level' => 'int',
'tax_type' => 'string',
'payment_method' => '\Swagger\Client\Model\ModelInvoiceUpdatePaymentMethod',
'cost_centre' => '\Swagger\Client\Model\ModelInvoiceUpdateCostCentre',
'send_date' => '\DateTime',
'origin' => '\Swagger\Client\Model\ModelInvoiceUpdateOrigin',
'invoice_type' => 'string',
...
'tax_set' => '\Swagger\Client\Model\ModelInvoiceUpdateTaxSet',
'address' => 'string',
'currency' => 'string',
'sum_net' => 'float',
'sum_tax' => 'float',
...
self::SEND_TYPE_VP,        ];
     ...
     * Gets contact
     *
     * @return \Swagger\Client\Model\ModelInvoiceUpdateContact
     */
     ...
     * Sets contact
     *
     * @param \Swagger\Client\Model\ModelInvoiceUpdateContact $contact contact
     *
     * @return $this
     */
     ...
     * Sets discount_time
     *
     * @param int $discount_time If a value other than zero is used for the discount attribute,      you need to specify the amount of days for which the discount is granted.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Please have a look in our       <a href='https://api.sevdesk.de/#section/Types-and-status-of-invoices'>Types and status of invoice</a>       to see what the different status codes mean
     *
     * @return $this
     */
     ...
     * Gets payment_method
     *
     * @return \Swagger\Client\Model\ModelInvoiceUpdatePaymentMethod
     */
     ...
     * Sets payment_method
     *
     * @param \Swagger\Client\Model\ModelInvoiceUpdatePaymentMethod $payment_method payment_method
     *
     * @return $this
     */
     ...
     * Gets cost_centre
     *
     * @return \Swagger\Client\Model\ModelInvoiceUpdateCostCentre
     */
     ...
     * Sets cost_centre
     *
     * @param \Swagger\Client\Model\ModelInvoiceUpdateCostCentre $cost_centre cost_centre
     *
     * @return $this
     */
     ...
     * Gets origin
     *
     * @return \Swagger\Client\Model\ModelInvoiceUpdateOrigin
     */
     ...
     * Sets origin
     *
     * @param \Swagger\Client\Model\ModelInvoiceUpdateOrigin $origin origin
     *
     * @return $this
     */
     ...
     * Sets reminder_total
     *
     * @param float $reminder_total Total reminder amount
     *
     * @return $this
     */
     ...
     * Sets reminder_debit
     *
     * @param float $reminder_debit Debit of the reminder
     *
     * @return $this
     */
     ...
     *
     * @param int $reminder_deadline Deadline of the reminder as timestamp
     *
     * @return $this
     */
     ...
     *
     * @param float $reminder_charge The additional reminder charge
     *
     * @return $this
     */
     ...
     * Gets tax_set
     *
     * @return \Swagger\Client\Model\ModelInvoiceUpdateTaxSet
     */
     ...
     * Sets tax_set
     *
     * @param \Swagger\Client\Model\ModelInvoiceUpdateTaxSet $tax_set tax_set
     *
     * @return $this
     */
     ...
     *
     * @param int $send_payment_received_notification_date Internal attribute
     *
     * @return $this
     */
